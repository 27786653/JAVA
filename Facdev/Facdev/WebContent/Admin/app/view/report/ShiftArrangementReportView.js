 ...
 * @module 测试报表
 */
Ext.define('App.view.report.ShiftArrangementReportView', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.ShiftArrangementReportView',
	requires : [ 'Ext.ux.IFrame' ],
	initComponent : function() {
		var me = this;

		var url='./frameset?__report=ShiftArrangementReport.rptdesign&__showtitle=false&__locale=zh_CN';
