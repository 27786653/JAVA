 ...
 * @module 保安排班报表
 */
Ext.define('App.view.report.BaoAnShiftReportView', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.BaoAnShiftReportView',
	requires : [ 'Ext.ux.IFrame','Ext.ux.Month'],
	initComponent : function() {
		var me = this;

		var url='./frameset?__report=BaoAnShiftReport.rptdesign&__showtitle=false&__locale=zh_CN';
