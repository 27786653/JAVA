 ...
 * @module 测试报表
 */
Ext.define('App.view.report.BadgeBaseGroupReportView', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.BadgeBaseGroupReportView',
	requires : [ 'Ext.ux.IFrame' ],
	initComponent : function() {
		var me = this;

		var url='./frameset?__report=BadgeBaseGroupReport.rptdesign&__showtitle=false&__locale=zh_CN';
